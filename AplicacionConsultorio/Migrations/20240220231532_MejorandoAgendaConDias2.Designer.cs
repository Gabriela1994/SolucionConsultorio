...
namespace AplicacionConsultorio.Migrations
{
    ...
    [Migration("20240220231532_MejorandoAgendaConDias2")]
    partial class MejorandoAgendaConDias2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AplicacionConsultorio.Models.Agenda", b =>
                {
                    b.HasOne("AplicacionConsultorio.Models.DiaSemana", "Dia_semana")
                        .WithMany("Agendas")
                        .HasForeignKey("Dia_semanaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AplicacionConsultorio.Models.Persona", "Profesional")
                        .WithMany("Agendas")
                        .HasForeignKey("ProfesionalID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Dia_semana");
