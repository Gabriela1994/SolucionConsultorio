...
namespace AplicacionConsultorio.Migrations
{
    ...
    [Migration("20240227164753_AgregarTablaTurnosYTablasSatelites")]
    partial class AgregarTablaTurnosYTablasSatelites
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AplicacionConsultorio.Models.Turno", b =>
                {
                    ...
                    b.Property<int>("IdPacienteIdPersona")
                        .HasColumnType("int");

                    b.Property<int>("IdProfesionalIdPersona")
                        .HasColumnType("int");

                    b.Property<int>("Id_estadoTurnoID")
                        .HasColumnType("int");

                    b.Property<int>("Id_tipoConsultaID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IdPacienteIdPersona");

                    b.HasIndex("IdProfesionalIdPersona");

                    b.HasIndex("Id_estadoTurnoID");

                    b.HasIndex("Id_tipoConsultaID");
            ...
            modelBuilder.Entity("AplicacionConsultorio.Models.Turno", b =>
                {
                    b.HasOne("AplicacionConsultorio.Models.PacienteXObraSocial", "IdPaciente")
                        .WithMany("Turno")
                        .HasForeignKey("IdPacienteIdPersona")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AplicacionConsultorio.Models.ProfesionalXEspecialidad", "IdProfesional")
                        .WithMany("Turno")
                        .HasForeignKey("IdProfesionalIdPersona")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AplicacionConsultorio.Models.Estado_turno", "Id_estadoTurno")
                        .WithMany("Turnos")
                        .HasForeignKey("Id_estadoTurnoID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AplicacionConsultorio.Models.Tipo_consulta", "Id_tipoConsulta")
                        .WithMany("Turnos")
                        .HasForeignKey("Id_tipoConsultaID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("Id_estadoTurno");

                    b.Navigation("Id_tipoConsulta");
                });
